...
<form id="form1" name="form1" method="post" action="">
  <div align="center">
    <table class="form" width="1000" border="1" cellpadding="0" cellspacing="0" bgcolor="#CCCCCC">
      <tr>
        <th colspan="14" align="center" class="QEEQEW" scope="row">學員管理系統-Administrator</th>
      </tr>
      <tr>
        ...
        <td width="10%" align="center" class="title-1">通訊地址 </td>
        <td width="7%" align="center" class="title-1">照片</td>
        <td width="7%" align="center" class="title-1">點擊次數</td>
        <td width="7%" align="center" class="title-1">新增</td>
        <td width="7%" align="center" class="title-1">修改</td>
        <td width="7%" align="center" class="title-1">刪除</td>
      </tr>
      <?php do { ?>
        <tr class="ERER">
          ...
          <td width="10%" align="center"><?php echo $row_Recordset1['stud_address']; ?></td>
          ...
          <td width="7%" align="center"><a href="results/add.php" target="main"><img src="images/plus-icon.gif" width="20" height="20" /></a></td>
          <td width="7%" align="center"><img src="images/editor.gif" width="20" height="20" /></td>
          <td width="7%" align="center"><a href="results/delete.php" target="main"><img src="images/kisspng-computer-icons-vector-graphics-image-icon-design-i-flat-delete-icon-bing-images-5b7b43bf9584a3.gif" width="20" height="29" /></a></td>
        </tr>
